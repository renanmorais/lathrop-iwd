const sponsors = {
  ...
  companies: {
    name: "Empresas que contribuiem com a comunidade local e se preocupam com seus colaboradores",
    items: [
      // { name: "Vólus", logo: "/parceiros/volus.jpeg" },
      // { name: "Prodata", logo: "/parceiros/prodata.png" },
