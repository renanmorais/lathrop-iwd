...
const ticketBatches: Array<TicketBatch> = [
    ...
    new TicketBatch({ description: 'Entrada + Kit', firstSaleDate: new Date('2023-03-07'), finalSaleDate: new Date('2023-03-20'), title: '2º Lote', link: 'https://doity.com.br/iwd-cerrado-2023#registration', value: 65 }),
