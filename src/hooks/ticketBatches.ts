...
const ticketBatches: Array<TicketBatch> = [
    new TicketBatch({ description: 'Kit + camiseta', firstSaleDate: new Date('2022-11-01'), finalSaleDate: new Date('2022-11-15'), title: '3º Lote', link: 'https://doity.com.br/devfest-cerrado-2022#registration', value: 150 }),
    ...
    new TicketBatch({ description: 'Kit + camiseta', firstSaleDate: new Date('2022-09-26'), finalSaleDate: new Date('2022-10-31'), title: '2º Lote', link: 'https://doity.com.br/devfest-cerrado-2022#registration', value: 120 }),
    new TicketBatch({ description: 'Kit', firstSaleDate: new Date('2022-09-26'), finalSaleDate: new Date('2022-10-31'), title: '2º Lote', link: 'https://doity.com.br/devfest-cerrado-2022#registration', value: 100 }),
